...
export default function Home() {
	...
	const handleNumOneChange = React.useCallback(
		(x: any) => {
	...
	const handleNumTwoChange = React.useCallback(
		(x: any) => {
			console.log('here2')
			...
			<div style={SumStyles}>
				...
				<div>
					<div style={InputDivStyles}>
						<input style={InputStyles} onChange={handleNumOneChange} value={numOne}></input>
						<div style={ResultStyles}>+</div>
						<input style={InputStyles} onChange={handleNumTwoChange} value={numTwoDisplay}></input>
						<div style={ResultStyles}>=</div>
